...
module.exports = {
  ...
  apps: {
    ...
    'android.debug': {
      ...
      build:
        'cd android && ./gradlew clean assembleDebug assembleAndroidTest -DtestBuildType=debug',
      reversePorts: [8081],
    },
    'android.release': {
      type: 'android.apk',
      ...
      build:
        'cd android && ./gradlew clean assembleRelease assembleAndroidTest -DtestBuildType=release',
    },
  },
  devices: {
    simulator: {
